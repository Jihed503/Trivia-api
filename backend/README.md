...
- Returns: An object with two key, success, categories, that contains a object of id: category_string key:value pairs.
  {'1' : "Science",
  '2' : "Art",
  '3' : "Geography",
  '4' : "History",
...
- Returns: An object with five keys: success, questions, total_questions, current_category, and categories
  {
  "categories": {
  "1": "Science",
  "2": "Art",
...
- Returns: An object with two keys, success, deleted_question_id
  {
  'success': True
...
- Request Arguments: None
- Returns: an object with four keys: success, questions, search_term, result_number.
...
- Request Arguments: None
- Returns: An object with four keys: success, quiz_category, question and previous_questions
